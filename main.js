...
function pass(){
    const password="mp@384";
   var pass=document.getElementById("pwd").value;
    if(pass == password){
        document.location="tel:+919562638079";
    }
    else if(pass == 0){
        document.getElementById("password").style.display="none";
        document.getElementById("ph").style.color="black";
        document.getElementById("ph").innerHTML="ENTER THE PASSWORD";
    }
    else {
    
    document.getElementById("ph").style.color="red";
      document.getElementById("ph").innerHTML="WRONG PASSWORD";
